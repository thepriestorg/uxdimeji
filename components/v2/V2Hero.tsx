  ...
  return (
    <section className="hero" id="top">
      ...
      <div className="hero-copy">
        <h1 className="reveal">
          <span className="hero-line hero-line-primary"><span className="hero-line-inner">Hi, I&apos;m Oladimeji. I design products,</span></span>
          <span className="hero-line hero-line-secondary"><span className="hero-line-inner">and help bring them to life.</span></span>
        </h1>
        <div className="hero-support reveal">
          ...
          <div className="hero-actions">
            <a className="hero-work-link" href="#work" onClick={jumpToSelectedWork}>View selected work <span className="arrow-icon arrow-down" aria-hidden="true" /></a>
            <a className="hero-cv-button" href="https://drive.google.com/file/d/1IsLsaqiIbkBeLbse-dz8QaVgegscdreC/view?usp=sharing" target="_blank" rel="noopener noreferrer">Read CV <ArrowUpRight aria-hidden="true" /></a>
          </div>
